...
import CreateClipModal from "@/components/coaching/CreateClipModal";

// ─── Helper: parse "MM:SS" or "HH:MM:SS" timestamp → seconds ────────────

function parseSeconds(ts: string | undefined): number {
  if (!ts) return 0;
  if (ts.includes("T")) return 0; // ISO timestamp fallback
