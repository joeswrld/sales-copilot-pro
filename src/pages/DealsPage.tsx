...
const STAGES = [
  ...
  { key: "qualified", label: "Qualified", color: "#22315C", glow: "rgba(96,165,250,0.15)", icon: "◈", order: 1 },
...
function HealthBar({ score }: { score: number }) {
  ...
  return (
    <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
      <div style={{ flex: 1, height: 3, borderRadius: 2, background: "rgba(23,23,15,0.06)", overflow: "hidden" }}>
  ...
  return (
    <div
      ...
      style={{
        ...
        border: "1px solid rgba(23,23,15,0.06)",
        borderRadius: 12,
        padding: "12px 14px",
        cursor: "pointer",
      ...
      onMouseEnter={e => {
        (e.currentTarget as HTMLDivElement).style.background = "rgba(23,23,15,0.045)";
        (e.currentTarget as HTMLDivElement).style.borderColor = cfg.color + "40";
        (e.currentTarget as HTMLDivElement).style.transform = "translateY(-1px)";
      }}
      onMouseLeave={e => {
        (e.currentTarget as HTMLDivElement).style.background = "rgba(23,23,15,0.025)";
        (e.currentTarget as HTMLDivElement).style.borderColor = "rgba(23,23,15,0.06)";
    ...
    >
      ...
      <div style={{ paddingLeft: 6 }}>
        <div style={{ fontSize: 13, fontWeight: 700, color: "rgba(23,23,15,0.9)", marginBottom: 3, lineHeight: 1.3, fontFamily: "'Inter', sans-serif", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
          {deal.name}
        </div>
        {deal.company && (
          <div style={{ fontSize: 11, color: "rgba(23,23,15,0.38)", marginBottom: 8, display: "flex", alignItems: "center", gap: 4 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" }}>
          {deal.call_count > 0 && (
            <span style={{ display: "flex", alignItems: "center", gap: 3, fontSize: 10, color: "rgba(23,23,15,0.3)" }}>
              <Phone style={{ width: 9, height: 9 }} />{deal.call_count}
            </span>
          )}
          {deal.last_call_at && (
            <span style={{ fontSize: 10, color: "rgba(23,23,15,0.25)" }}>
        ...
        {(deal.next_best_action || deal.next_step) && (
          <div style={{ marginTop: 6, display: "flex", alignItems: "center", gap: 4, fontSize: 10, color: "#22315C", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
  ...
  return (
    <div
      ...
      style={{
        ...
        padding: "13px 14px",
        borderBottom: "1px solid rgba(23,23,15,0.04)",
        cursor: "pointer",
        position: "relative",
        WebkitTapHighlightColor: "transparent",
      }}
    >
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 8, marginBottom: 2 }}>
          <div style={{ fontSize: 13, fontWeight: 700, color: "rgba(23,23,15,0.88)", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", fontFamily: "'Inter', sans-serif" }}>
            {deal.name}
          </div>
          {deal.value && (
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" }}>
          ...
          {deal.company && <span style={{ fontSize: 11, color: "rgba(23,23,15,0.3)" }}>{deal.company}</span>}
          {deal.call_count > 0 && (
            <span style={{ display: "flex", alignItems: "center", gap: 3, fontSize: 10, color: "rgba(23,23,15,0.3)" }}>
              <Phone style={{ width: 9, height: 9 }} />{deal.call_count}
            </span>
...
function DealListRow({ deal, onClick }: { deal: Deal; onClick: () => void }) {
  ...
  return (
    <div
      onClick={onClick}
      style={{ display: "grid", gridTemplateColumns: "1fr 80px 80px 70px 80px 100px 28px", alignItems: "center", gap: 12, padding: "10px 14px", borderBottom: "1px solid rgba(23,23,15,0.04)", cursor: "pointer", transition: "background 0.1s", WebkitTapHighlightColor: "transparent" }}
      onMouseEnter={e => (e.currentTarget as HTMLDivElement).style.background = "rgba(23,23,15,0.03)"}
      onMouseLeave={e => (e.currentTarget as HTMLDivElement).style.background = "transparent"}
    >
      <div style={{ minWidth: 0 }}>
        <div style={{ fontSize: 13, fontWeight: 600, color: "rgba(23,23,15,0.85)", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", fontFamily: "'Inter', sans-serif" }}>{deal.name}</div>
        {deal.company && <div style={{ fontSize: 11, color: "rgba(23,23,15,0.3)" }}>{deal.company}</div>}
      </div>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
        <div style={{ width: 32, height: 4, borderRadius: 2, background: "rgba(23,23,15,0.08)", overflow: "hidden" }}>
      ...
      <div style={{ fontSize: 11, color: "rgba(23,23,15,0.3)" }}>
        {deal.last_call_at ? formatDistanceToNow(new Date(deal.last_call_at), { addSuffix: true }) : "No calls"}
      </div>
      <div style={{ fontSize: 11, color: "#22315C", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
        {deal.next_best_action ?? deal.next_step ?? "—"}
      </div>
      <ChevronRight style={{ width: 14, height: 14, color: "rgba(23,23,15,0.2)" }} />
    </div>
  );
}
  ...
  return (
    ...
    >
      <div style={{
        ...
        background: dragOver ? stage.glow : "rgba(23,23,15,0.03)",
        border: `1px solid ${dragOver ? stage.color + "50" : "rgba(23,23,15,0.06)"}`,
        borderBottom: "none",
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 7 }}>
          ...
          <span style={{ fontSize: 12, fontWeight: 700, color: "rgba(23,23,15,0.75)", fontFamily: "'Inter', sans-serif" }}>{stage.label}</span>
          <span style={{ fontSize: 10, fontWeight: 700, color: "rgba(23,23,15,0.25)", background: "rgba(23,23,15,0.06)", borderRadius: 10, padding: "1px 6px" }}>{deals.length}</span>
        </div>
        {total > 0 && (
      ...
      <div style={{
        ...
        border: `1px solid ${dragOver ? stage.color + "40" : "rgba(23,23,15,0.04)"}`,
        borderTop: "none", borderRadius: "0 0 10px 10px",
        background: dragOver ? stage.glow : "rgba(23,23,15,0.01)",
        transition: "all 0.15s",
      }}>
        {deals.length === 0 && (
          <div style={{ textAlign: "center", padding: "20px 8px", color: "rgba(23,23,15,0.15)", fontSize: 11 }}>Drop deal here</div>
        )}
        {deals.map(deal => (
...
function MobileStageView({ byStage, onDealClick }: {
  ...
  return (
    <div>
            ...
            return (
              <button
                ...
                style={{
                  ...
                  padding: "7px 12px",
                  borderRadius: 10,
                  border: isActive ? `1px solid ${s.color}50` : "1px solid rgba(23,23,15,0.06)",
                  background: isActive ? `${s.color}18` : "rgba(23,23,15,0.03)",
                  color: isActive ? s.color : "rgba(23,23,15,0.4)",
              ...
              >
                ...
                {count > 0 && (
                  <span style={{
                    ...
                    borderRadius: 8, background: isActive ? `${s.color}30` : "rgba(23,23,15,0.08)",
                    color: isActive ? s.color : "rgba(23,23,15,0.3)",
      ...
      {/* Stage deals */}
      <div style={{ background: "rgba(23,23,15,0.02)", border: "1px solid rgba(23,23,15,0.05)", borderRadius: 12, overflow: "hidden" }}>
        {deals.length === 0 ? (
          <div style={{ padding: "32px 16px", textAlign: "center", color: "rgba(23,23,15,0.2)", fontSize: 12 }}>
...
function CreateDealModal({ open, onClose, onCreated }: { open: boolean; onClose: () => void; onCreated: () => void }) {
  ...
  return (
    <div style={{ position: "fixed", inset: 0, zIndex: 9999, background: "rgba(23,23,15,0.45)", backdropFilter: "blur(12px)", display: "flex", alignItems: "flex-end", justifyContent: "center", padding: 0 }}
    ...
    >
      <div style={{
        ...
        boxShadow: "0 -20px 80px -16px rgba(23,23,15,0.35)",
        maxHeight: "92vh",
        overflowY: "auto",
      }}>
        {/* Handle */}
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 20 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <span style={{ fontSize: 16, fontWeight: 800, color: "#17170F", fontFamily: "'Inter', sans-serif" }}>New Deal</span>
          </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          {[
            ...
            <div key={key}>
              <label style={{ fontSize: 11, fontWeight: 600, color: "rgba(23,23,15,0.4)", display: "block", marginBottom: 5, fontFamily: "'Inter', sans-serif" }}>{label}</label>
              <input
                type={type ?? "text"}
                ...
                style={{ width: "100%", padding: "11px 12px", background: "rgba(23,23,15,0.05)", border: "1px solid rgba(23,23,15,0.08)", borderRadius: 10, color: "#17170F", fontSize: 14, fontFamily: "'Inter', sans-serif", outline: "none", boxSizing: "border-box" }}
              />
            </div>
          ))}
          <div>
            <label style={{ fontSize: 11, fontWeight: 600, color: "rgba(23,23,15,0.4)", display: "block", marginBottom: 5, fontFamily: "'Inter', sans-serif" }}>Stage</label>
            <select
              value={form.stage}
              onChange={e => setForm(f => ({ ...f, stage: e.target.value }))}
              style={{ width: "100%", padding: "11px 12px", background: "rgba(23,23,15,0.05)", border: "1px solid rgba(23,23,15,0.08)", borderRadius: 10, color: "#17170F", fontSize: 14, fontFamily: "'Inter', sans-serif", outline: "none" }}
            >
        ...
        <button
          ...
          style={{ width: "100%", marginTop: 18, padding: "14px", borderRadius: 12, border: "none", background: form.name.trim() ? "#22315C" : "rgba(23,23,15,0.06)", color: form.name.trim() ? "#FAFAF8" : "rgba(23,23,15,0.3)", fontSize: 14, fontWeight: 700, fontFamily: "'Inter', sans-serif", cursor: form.name.trim() ? "pointer" : "not-allowed", display: "flex", alignItems: "center", justifyContent: "center", gap: 8, boxShadow: form.name.trim() ? "0 8px 24px rgba(34,49,92,0.3)" : "none" }}
        >
...
function PipelineStats({ deals }: { deals: Deal[] }) {
  ...
  return (
    <div style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: 8 }}>
      {[
        { label: "Pipeline", value: formatCurrency(totalValue) ?? "$0", icon: DollarSign, color: "#22315C", sub: `${active.length} active` },
        ...
        <div key={label} style={{ background: "rgba(23,23,15,0.025)", border: "1px solid rgba(23,23,15,0.06)", borderRadius: 12, padding: "12px 14px" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 5 }}>
            <Icon style={{ width: 12, height: 12, color }} />
            <span style={{ fontSize: 10, color: "rgba(23,23,15,0.35)", fontFamily: "'Inter', sans-serif" }}>{label}</span>
          </div>
          <div style={{ fontSize: 18, fontWeight: 900, color: "rgba(23,23,15,0.9)", fontFamily: "'Inter', sans-serif", lineHeight: 1 }}>{value}</div>
          <div style={{ fontSize: 10, color: "rgba(23,23,15,0.2)", marginTop: 3 }}>{sub}</div>
        </div>
      ))}
    </div>
  );
...
export default function DealsPage() {
  ...
  const css = `
    ...
    ::-webkit-scrollbar-thumb { background: rgba(23,23,15,0.1); border-radius: 4px; }
  `;
  ...
  return (
    <DashboardLayout>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: isMobile ? 14 : 18, fontFamily: "'Inter', sans-serif" }}>

        {/* Header */}
        <div style={{ display: "flex", alignItems: isMobile ? "center" : "flex-start", justifyContent: "space-between", gap: 10 }}>
          <div style={{ minWidth: 0 }}>
            <h1 style={{ fontSize: isMobile ? 20 : 26, fontWeight: 900, color: "#17170F", margin: 0, letterSpacing: "-0.5px", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
              {isMobile ? "Deals" : "Revenue Command Center"}
            </h1>
            {!isMobile && (
              <p style={{ fontSize: 13, color: "rgba(23,23,15,0.35)", margin: "4px 0 0" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8, flexShrink: 0 }}>
            {isMobile && (
              <button
                ...
                style={{ width: 36, height: 36, borderRadius: 10, border: "1px solid rgba(23,23,15,0.08)", background: "rgba(23,23,15,0.04)", color: "rgba(23,23,15,0.5)", display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer" }}
              >
            ...
            <button
              ...
              style={{ display: "flex", alignItems: "center", gap: isMobile ? 0 : 8, padding: isMobile ? "0" : "10px 18px", width: isMobile ? 36 : "auto", height: isMobile ? 36 : "auto", justifyContent: "center", background: "linear-gradient(135deg, #22315C, #2A3F73)", border: "none", borderRadius: isMobile ? 10 : 12, color: "#FAFAF8", fontSize: 13, fontWeight: 700, cursor: "pointer", boxShadow: "0 8px 24px rgba(59,130,246,0.35)", fontFamily: "'Inter', sans-serif" }}
            >
        ...
        {isMobile && searchOpen && (
          <div style={{ position: "relative" }}>
            <Search style={{ position: "absolute", left: 10, top: "50%", transform: "translateY(-50%)", width: 14, height: 14, color: "rgba(23,23,15,0.3)" }} />
            <input
              autoFocus
              value={search}
              onChange={e => setSearch(e.target.value)}
              placeholder="Search deals…"
              style={{ width: "100%", paddingLeft: 34, paddingRight: search ? 34 : 12, paddingTop: 10, paddingBottom: 10, background: "rgba(23,23,15,0.06)", border: "1px solid rgba(23,23,15,0.1)", borderRadius: 10, color: "#17170F", fontSize: 14, fontFamily: "'Inter', sans-serif", outline: "none", boxSizing: "border-box" }}
            />
            {search && (
              <button onClick={() => setSearch("")} style={{ position: "absolute", right: 10, top: "50%", transform: "translateY(-50%)", background: "none", border: "none", color: "rgba(23,23,15,0.3)", cursor: "pointer", padding: 4 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10, flexWrap: "wrap" }}>
            <div style={{ position: "relative", flex: 1, minWidth: 200, maxWidth: 320 }}>
              ...
              <input
                ...
                onChange={e => setSearch(e.target.value)}
                placeholder="Search deals…"
                style={{ width: "100%", paddingLeft: 32, paddingRight: search ? 32 : 12, paddingTop: 8, paddingBottom: 8, background: "rgba(23,23,15,0.04)", border: "1px solid rgba(23,23,15,0.07)", borderRadius: 10, color: "#17170F", fontSize: 13, fontFamily: "'Inter', sans-serif", outline: "none", boxSizing: "border-box" }}
              />
            ...
            <div style={{ display: "flex", gap: 5, flexWrap: "wrap" }}>
              {[{ key: "all", label: "All" }, ...KANBAN_STAGES].map(s => (
                <button
                  ...
                  style={{ fontSize: 11, fontWeight: 600, padding: "5px 10px", borderRadius: 8, border: "none", background: stageFilter === s.key ? "rgba(23,23,15,0.12)" : "rgba(23,23,15,0.04)", color: stageFilter === s.key ? "#17170F" : "rgba(23,23,15,0.35)", cursor: "pointer", fontFamily: "'Inter', sans-serif" }}
                >
                  {s.key === "all" ? "All" : (s as any).label}
                </button>
              ))}
            </div>
            <div style={{ marginLeft: "auto", display: "flex", gap: 3, background: "rgba(23,23,15,0.04)", borderRadius: 8, padding: 3 }}>
              {[{ mode: "kanban" as const, icon: LayoutGrid }, { mode: "list" as const, icon: List }].map(({ mode, icon: Icon }) => (
                <button
                  key={mode}
                  onClick={() => setViewMode(mode)}
                  style={{ padding: "5px 8px", borderRadius: 6, border: "none", background: viewMode === mode ? "rgba(23,23,15,0.1)" : "transparent", color: viewMode === mode ? "#17170F" : "rgba(23,23,15,0.3)", cursor: "pointer" }}
                >
                  <Icon style={{ width: 14, height: 14 }} />
                </button>
              ))}
            </div>
            <button onClick={loadDeals} style={{ padding: "7px", borderRadius: 8, border: "1px solid rgba(23,23,15,0.07)", background: "rgba(23,23,15,0.03)", color: "rgba(23,23,15,0.4)", cursor: "pointer" }}>
        ...
        {isMobile && (
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            <div style={{ display: "flex", gap: 3, background: "rgba(23,23,15,0.04)", borderRadius: 8, padding: 3 }}>
              {[{ mode: "kanban" as const, icon: LayoutGrid, label: "Kanban" }, { mode: "list" as const, icon: List, label: "List" }].map(({ mode, icon: Icon, label }) => (
                <button
                  key={mode}
                  onClick={() => setViewMode(mode)}
                  style={{ display: "flex", alignItems: "center", gap: 5, padding: "6px 10px", borderRadius: 6, border: "none", background: viewMode === mode ? "rgba(23,23,15,0.1)" : "transparent", color: viewMode === mode ? "#17170F" : "rgba(23,23,15,0.35)", cursor: "pointer", fontSize: 12, fontWeight: 600, fontFamily: "'Inter', sans-serif" }}
                >
                  <Icon style={{ width: 13, height: 13 }} />{label}
                </button>
              ))}
            </div>
            <button onClick={loadDeals} style={{ marginLeft: "auto", padding: "8px", borderRadius: 8, border: "1px solid rgba(23,23,15,0.07)", background: "rgba(23,23,15,0.03)", color: "rgba(23,23,15,0.4)", cursor: "pointer" }}>
              <RefreshCw style={{ width: 14, height: 14 }} />
            </button>
          </div>
        )}
        ...
        {loading ? (
          ...
          <div style={{ textAlign: "center", padding: "48px 20px", color: "rgba(23,23,15,0.2)" }}>
            ...
            {deals.length === 0 && (
              <button onClick={() => setCreateOpen(true)} style={{ padding: "10px 20px", background: "linear-gradient(135deg, #22315C, #2A3F73)", border: "none", borderRadius: 10, color: "#FAFAF8", fontSize: 13, fontWeight: 700, cursor: "pointer", fontFamily: "'Inter', sans-serif" }}>
          ...
          /* Desktop List */
          <div style={{ background: "rgba(23,23,15,0.02)", border: "1px solid rgba(23,23,15,0.06)", borderRadius: 14, overflow: "hidden" }}>
            <div style={{ display: "grid", gridTemplateColumns: "1fr 80px 80px 70px 80px 100px 28px", gap: 12, padding: "8px 14px", borderBottom: "1px solid rgba(23,23,15,0.06)", background: "rgba(23,23,15,0.02)" }}>
              {["Deal", "Stage", "Value", "Health", "Last Call", "Next Action", ""].map((h, i) => (
                <span key={i} style={{ fontSize: 10, fontWeight: 700, color: "rgba(23,23,15,0.25)", textTransform: "uppercase", letterSpacing: "0.08em" }}>{h}</span>
              ))}
            </div>
